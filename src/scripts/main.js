$(document).ready(function(){
  ...
  tags();
  /* Избранное клик */
  $('.fav-star path').click(function(){
    if($(this).parent().parent().parent().attr('data-favourites') == '0'){
      $(this).parent().parent().parent().attr('data-favourites', '1');
    } else{
      $(this).parent().parent().parent().attr('data-favourites', '0');
    }
    tags();
  });
